...
class site_info
{
    public const CMS_TYPE_WORDPRESS = 'WordPress';

    public const CMS_TYPE_DRUPAL = 'Drupal';

    private ?string $_client_name;

    private ?string $_site_purpose;

    private ?int $_site_year;

    private ?string $_cms_type;

    private ?string $_sub_domain;

    private ?string $_stage_type;

    private ?string $_database_name;

    private ?string $_domain_base;

    public function show_summary(SymfonyStyle $io): void
    {
        $io->table(
            [
                'Client Name',
    ...
    public function set_domain_base(string $domain_base): void
    {
        $this->_domain_base = $domain_base;
    }

    public function set_database_name(string $database_name): void
    {
        $this->_database_name = $database_name;
    }

    public function set_stage_type(string $stage_type): void
    {
        $this->_stage_type = $stage_type;
    }

    public function set_client_name(string $client_name): void
    {
        $this->_client_name = $client_name;
    }

    public function set_sub_domain(string $sub_domain): void
    {
    ...
    public function set_cms_type(string $cms_type): void
    {
    ...
    public function set_site_year(int $site_year): void
    {
        $this->_site_year = $site_year;
    }

    public function set_site_purpose(string $site_purpose): void
    {
